...
{
	private static final long	serialVersionUID	= 130918021919279241L;
	...
	public DifferenceChartDemo2(final String title)
	{
		...
		// slope 1
		final XYSeries series1 = new XYSeries("X = Y");
		series1.add(0.0, 0.0);
		series1.add(6.0, 6.0);
		
		// slope 0.5
		final XYSeries series2 = new XYSeries("X = Y");
		series2.add(0.0, 0.0);
		series2.add(6.0, 3.0);
	...
	private JFreeChart createChart(final XYDataset dataset)
	{
		...
		final XYDifferenceRenderer renderer = new XYDifferenceRenderer(Color.LIGHT_GRAY, Color.LIGHT_GRAY, false);
				
		renderer.setSeriesPaint(0, Color.black);
		renderer.setSeriesPaint(1, Color.black);
		renderer.setSeriesStroke(0, new BasicStroke(1.0f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 1.0f, new float[] { 6.0f, 6.0f }, 0.0f));
