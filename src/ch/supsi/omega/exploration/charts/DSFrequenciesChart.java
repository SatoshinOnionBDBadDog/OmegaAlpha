...
public class DSFrequenciesChart extends JFrame
{
	...
	/**
	 * Displays the JFreeChart chart.
	 */
	public ChartPanel displayChart()
	{
	...
	private JFreeChart createChart(final CategoryDataset dataset)
	{
		...
		{
			GradientPaint gp = new GradientPaint(0.0f, 0.0f, color,  0.0f, 0.0f, Color.lightGray);
	 ...
	 * @param values
	 */
	public void addDataToChart(String datasetName, int[] values)
	{
		int sum = values[1] + values[2] + values[3] + values[4];
		
		if(sum > 0)
		{
			dataset.addValue(100*values[1]/sum, series1, datasetName);
			dataset.addValue(100*values[2]/sum, series2, datasetName);
			dataset.addValue(100*values[3]/sum, series3, datasetName);
			dataset.addValue(100*values[4]/sum, series4, datasetName);
		}
	}
}
